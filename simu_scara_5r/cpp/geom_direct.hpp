 ...
 *
 *  \param q1 : Joint parameter of the first angle (left motor)
 *  \param q5 : Joint parameter of the last angle (right motor)
 *  \return Reached point by articular parameters
 */
